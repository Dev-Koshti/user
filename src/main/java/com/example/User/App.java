...
//        messageFactory.setUseBinaryMessages(false); // Ensure non-binary mode if applicable
//        messageFactory.setIgnoreLastMissingField(true); // Ignore undefined trailing fields
//        messageFactory.setForceStringEncoding(true); // Ensure proper encoding
